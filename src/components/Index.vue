        ...
        <yd-tab-panel label="有长险保单">
          ...
          <div :class="['table',{'greenBg':index%2!=0}]" v-for="(item,index) in hasChit.applicants">
            <h1>
              ...
              <span class="phone"><i></i><a :tel="item.phone">{{item.phone}}</a></span>
              <span class="more">更多</span>
            </h1>
            <div class="tbody" v-for="(val,i) in item.insured">
              <h2>
                <span class="lf">{{'被保人：'+val.insuredname}}</span>
                <span class="rt"><i></i>{{'投被保险人关系：'+val.relationship}}</span>
              </h2>
              <ul>
                <li class="title">
                  <span>险种名称</span>
...
div.container{
  ...
  div.table{
    ...
    h1{
      font-size:1.4em;color:@deepRed;font-weight:bold;position:relative;
      span{
        ...
        &.phone{
          ...
          i{
            position:absolute;left:0rem;top:0;width:1.5rem;height:1.5rem;background:url('../assets/img/phone.png') no-repeat center center; background-size: 100%;vertical-align:bottom;
          }
        }
        &.more{
          // width:10%;
          position:absolute;top:-.2rem;right: 0;padding:.3rem .5rem;border: 1px solid @deepRed;border-radius:5px;font-weight:normal;font-size:1rem;
        }
      }
    ...
    div.tbody{
      ...
      h2{
          height:2rem;line-height: 2;font-size:1rem;margin:1rem .5rem;color:@deepRed;
      }
      ul{
        li{
  ...
  div.table2{
    ...
    div.tbody{
      margin-top: 1rem;border:1px solid @deepRed;border-radius:5px;padding-bottom:1rem;
      h2{
          height:2rem;line-height: 2;font-size:1rem;margin:.3rem 5%;color:@deepRed;font-weight:bold;
      }
      ul{
  ...
  .guide_mask{
    ...
    .bgBorder{
      position:absolute;top:50%;left:0;transform:translateY(-50%);background:url('../assets/img/popBg.png') no-repeat center center;background-size:100%;height:40%;
      padding: 22% 5% 0 23%;
      p{
        font-size:.9rem;
      }
      span{
        position:absolute;top:16%;right:12%;width:3em;height:3em;
      }
    }
  }
}
